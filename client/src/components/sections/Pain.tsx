  ...
  return (
    <section className="py-20 md:py-32 bg-card section-bg-animated relative">
      ...
      <div className="container mx-auto px-4 relative z-10">
        {/* Heading */}
        <h2 className="text-4xl md:text-5xl font-bold text-center mb-4 text-foreground fade-in">
          Это не для тех, кто только слышал про ChatGPT.
        </h2>
        <p className="text-center text-lg text-muted mb-12 max-w-2xl mx-auto">
          Это для предпринимателей, которые уже используют AI — но до сих пор делают это <span className="text-accent font-bold">руками, по одному инструменту, без связки между ними</span>.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
          {pains.map((pain, index) => (
            <div
              key={index}
              className="card-premium hover-lift border-l-4 border-accent card-entrance glow-pulse"
