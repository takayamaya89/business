        ...
        <div className="max-w-5xl mx-auto mb-16">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="bg-white border-t-4 border-green-600 p-8 rounded-lg shadow-lg" style={{ boxShadow: '0 0 20px rgba(34, 197, 94, 0.2)' }}>
                <h3 className="text-2xl font-bold text-gray-900 mb-4">
                  Кейс: E-commerce с масштабированием
                </h3>
                
                <div className="space-y-4 text-gray-700">
                  <p>
                    <span className="font-semibold text-gray-900">Проблема:</span> E-commerce магазин застрял на 50 000 ₽/месяц. Владелец работал 12 часов в день.
                  </p>

                  <p>
                    <span className="font-semibold text-gray-900">Решение:</span> Внедрили <span className="text-green-600 font-bold">систему ИИ-ассистентов</span>.
                  </p>

                  <ul className="space-y-2 ml-4">
                    <li className="flex gap-2">
                      <span className="text-green-600 font-bold flex-shrink-0">→</span>
                      <span>Анализа трендов и конкурентов</span>
                    </li>
                    <li className="flex gap-2">
                      <span className="text-green-600 font-bold flex-shrink-0">→</span>
                      <span>Создания контента для соцсетей</span>
                    </li>
                    <li className="flex gap-2">
                      <span className="text-green-600 font-bold flex-shrink-0">→</span>
                      <span>Управления рекламой и оптимизации</span>
                    </li>
                    <li className="flex gap-2">
                      <span className="text-green-600 font-bold flex-shrink-0">→</span>
                      <span>Обслуживания клиентов 24/7</span>
                    </li>
                  </ul>

                  <p className="pt-4 border-t border-gray-200">
                    <span className="font-semibold text-green-600">Результат:</span> За 3 месяца выручка выросла до <span className="text-green-600 font-bold">280 000 ₽/месяц</span>.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              {[
                { amount: '280 000 ₽', label: 'месячная выручка', desc: 'Рост с 50 000 ₽ за счёт автоматизации' },
                { amount: '3 месяца', label: 'до масштабирования', desc: 'От внедрения системы до 5.6x роста' },
                { amount: '-75% времени', label: 'на операционные задачи', desc: 'Владелец освободился для стратегии' }
              ].map((item, idx) => (
                <div 
                  key={idx}
                  className="border-l-4 border-green-600 pl-6 py-4 bg-white rounded shadow-sm hover:shadow-md transition-all"
                  style={{
                    boxShadow: '0 0 15px rgba(34, 197, 94, 0.2)',
                    animation: `bounceIn 0.8s ease-out ${0.2 * idx + 0.4}s both`
                  }}
                >
                  <div className="text-5xl md:text-6xl font-bold text-green-600 mb-2">
                    {item.amount}
