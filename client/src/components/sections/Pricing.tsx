        ...
        >
          <div className="text-center mb-8">
            ...
            <div className="space-y-3 text-gray-700 mb-8 pb-8 border-b-2 border-green-200">
              ...
              <p className="text-base">
                <span className="font-bold">Сравните:</span> хороший маркетолог стоит 80–150К в месяц. Здесь за 7 часов Вы получаете систему, которая делает его работу — навсегда.
              </p>
            </div>
          </div>
