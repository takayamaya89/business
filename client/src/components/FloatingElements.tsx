...
export default function FloatingElements() {
  return (
    <div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
      ...
      <motion.div
        className="absolute top-1/4 right-1/3 px-4 py-2 bg-black bg-opacity-50 border border-green-600 rounded text-sm font-mono text-green-400"
        animate={{
          y: [0, -20, 0],
          x: [0, 10, -10, 0],
        }}
      ...
      <motion.div
        className="absolute bottom-1/3 right-1/4 px-4 py-2 bg-black bg-opacity-50 border border-green-600 rounded text-sm font-mono text-green-400"
        animate={{
          y: [0, -20, 0],
          x: [0, 10, -10, 0],
        }}
      ...
      <motion.div
        className="absolute top-2/3 left-1/4 px-4 py-2 bg-black bg-opacity-50 border border-green-600 rounded text-sm font-mono text-green-400"
        animate={{
          y: [0, -20, 0],
          x: [0, 10, -10, 0],
        }}
